...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('role:admin')->group(function () {
        ...
        // Duyệt sửa điểm
        Route::get('duyet-sua-diem', [App\Http\Controllers\Admin\DuyetSuaDiemController::class, 'index'])->name('duyet-sua-diem.index');
        Route::post('duyet-sua-diem/{id}/duyet', [App\Http\Controllers\Admin\DuyetSuaDiemController::class, 'duyet'])->name('duyet-sua-diem.duyet');
        Route::post('duyet-sua-diem/{id}/tu-choi', [App\Http\Controllers\Admin\DuyetSuaDiemController::class, 'tuChoi'])->name('duyet-sua-diem.tu-choi');
    ...
    Route::prefix('giaovien')->name('giaovien.')->middleware('role:giaovien')->group(function () {
        ...
        Route::prefix('diem')->name('diem.')->group(function () {
            ...
            Route::post('/{id}/gui-yeu-cau', [App\Http\Controllers\GiaoVien\DiemController::class, 'guiYeuCau'])->name('gui-yeu-cau');

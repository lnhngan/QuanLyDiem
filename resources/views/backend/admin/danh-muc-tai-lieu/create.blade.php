...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Thêm Danh mục tài liệu</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.danh-muc-tai-lieu.store') }}" method="POST">
            @csrf
            
            <div class="mb-3">
                <label for="ten_danh_muc" class="form-label">Tên danh mục (VD: Đề thi, Sách giáo khoa) <span class="text-danger">*</span></label>
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Lưu danh mục</button>

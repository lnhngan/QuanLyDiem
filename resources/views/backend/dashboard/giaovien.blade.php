                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <a href="{{ route('giaovien.diem.danh-sach') }}" class="text-sm mt-2 d-inline-block">Xem danh
                                sách →</a>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <a href="{{ route('giaovien.tailieu.index') }}" class="text-sm mt-2 d-inline-block">Quản lý tài
                                liệu →</a>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            @if($lopChuNhiem)
                                ...
                                <a href="{{ route('giaovien.chunhiem.hocsinh') }}" class="text-sm mt-2 d-inline-block">Xem danh
                                    sách lớp →</a>
                            @else
                            ...
                            <tbody>
                                @forelse($danhSachLopDay as $pc)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('giaovien.diem.danh-sach') }}" class="btn btn-sm btn-primary">Vào
                                                điểm</a>
                                        </td>
                                    </tr>
                                @empty

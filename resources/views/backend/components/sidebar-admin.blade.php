    ...
    <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ request()->routeIs('admin.duyet-sua-diem.*') ? 'active' : '' }}"
                    href="{{ route('admin.duyet-sua-diem.index') }}">
                    <div class="sb-nav-link-icon"><i class="bi bi-shield-lock text-danger"></i></div>
                    Duyệt sửa điểm
                </a>
            </li>

    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                <h5><i class="bi bi-book-fill me-2"></i>THPT Nguyễn Bỉnh Khiêm</h5>
                <p class="text-white-50">Hệ thống quản lý điểm số và tài liệu học tập trực tuyến</p>
            </div>
            <div class="col-md-4 mb-4">
        ...
        <div class="text-center text-white-50">
            &copy; {{ date('Y') }} Trường THPT Nguyễn Bỉnh Khiêm. All rights reserved.
        </div>
    </div>
</footer>